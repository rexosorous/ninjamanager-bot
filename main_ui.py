...
class Ui_main_window(object):
    def setupUi(self, main_window):
        ...
        self.chrome_items_gained = QtWidgets.QTextEdit(self.frame_7)
        self.chrome_items_gained.setReadOnly(True)
        self.chrome_items_gained.setObjectName("chrome_items_gained")
        self.formLayout_3.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.chrome_items_gained)
        ...
        self.firefox_items_gained = QtWidgets.QTextEdit(self.frame_8)
        self.firefox_items_gained.setReadOnly(True)
        self.firefox_items_gained.setObjectName("firefox_items_gained")
        self.formLayout_4.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.firefox_items_gained)
